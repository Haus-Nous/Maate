    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              <span className="text-[10px] font-bold text-primary uppercase tracking-widest bg-primary/10 px-2 py-0.5 rounded-lg">Lab Report</span>
              <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">Thyrocare • Ref #92831</span>
            </div>
            <h1 className="text-3xl font-bold font-outfit tracking-tight">Full Health Screen</h1>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          <AISummaryCard 
            summary="This report indicates a significant improvement in your iron metabolism. However, your glucose levels (HbA1c) remain above the target range, suggesting a need for tighter dietary control or medication adjustment."
            keyFindings={[
          ...
          <LabResultTable markers={mockMarkers} />
        </div>
